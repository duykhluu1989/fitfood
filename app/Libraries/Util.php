...
class Util
{
    ...
    const PAYMENT_GATEWAY_MPOS_LABEL = 'mPOS';
    ...
    const BANK_TRANSFER_ACCOUNT_NAME = 'PHAM THI NGOC HIEU';
    const BANK_TRANSFER_VCB_ACCOUNT_NUMBER = 'VCB HCM - 0071001176931';
    const BANK_TRANSFER_ACB_ACCOUNT_NUMBER = 'ACB PGD Hai Ba Trung - 243329119';
    ...
    const ORDER_EXTRA_REQUEST_CHANGE_INGREDIENT_NO_SHRIMP_LABEL = 'Không hải sản';
    ...
    const ORDER_EXTRA_REQUEST_CHANGE_INGREDIENT_NO_SHRIMP_LABEL_EN = 'No seafood';
